...
const tiers = [
    ...
    },
    {
        ...
        perks: ['All previous perks', 'Monthly behind-the-scenes content', 'Vote on future projects']
    },
    {
        name: 'Rocket Booster',
        icon: Rocket,
        ...
        perks: ['All previous perks', 'Your name in the credits', 'Quarterly video call']
    }
]
        ...
        <div className="min-h-screen bg-gradient-to-b from-background to-muted dark:from-background dark:to-background/80 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="mt-4 text-xl text-muted-foreground">
                    Your support helps me create more amazing content and bring new ideas to life. Join my Patreon community and get exclusive perks!
                </p>
            </div>

            <div className="mt-12 max-w-lg mx-auto grid gap-8 lg:grid-cols-3 lg:max-w-none">
                {tiers.map((tier) => (
                    <Card key={tier.name} className="flex flex-col justify-between border-primary/10 dark:border-primary/20 hover:shadow-lg transition-shadow duration-300">
                        <CardHeader>
                        ...
                        <CardContent>
                            <p className="text-3xl font-bold text-foreground">{tier.price}<span className="text-sm font-normal text-muted-foreground">/month</span></p>
            ...
            <div className="mt-12 text-center">
                <div className="flex justify-center space-x-4">
                    <div className="flex items-center">
                        ...
                        <span className="text-sm text-muted-foreground">Support Anime</span>
                    </div>
                    <div className="flex items-center">
                        <Vote className="h-5 w-5 text-primary mr-2" />
                        <span className="text-sm text-muted-foreground">Vote for Next Anime</span>
                    </div>
                </div>
                <p className="mt-4 text-sm text-muted-foreground">
                    Your support helps us continue to provide free anime content to everyone!
                </p>
            </div>
        </div>
    )
