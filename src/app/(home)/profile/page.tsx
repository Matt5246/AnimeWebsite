...
import { Edit, Key, Bell, Settings, Star, Clock, BookOpen, TrendingUp } from 'lucide-react'
            ...
            <Tabs defaultValue="favorites">
                            ...
                            <Card key={anime}>
                                ...
                                <CardContent>
                                    <div className="flex justify-between items-center">
                                        ...
                                        <Badge>{anime === 'One Piece' ? '1000+' : anime === 'Naruto' ? '220' : '75'}</Badge>
                                    </div>
                ...
                <TabsContent value="history" className="space-y-4">
                    ...
                    <div className="space-y-4">
                        {['My Hero Academia', 'Demon Slayer', 'Jujutsu Kaisen'].map((anime) => (
                            <Card key={anime}>
                                <CardHeader>
                                    <CardTitle>{anime}</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <div className="flex justify-between items-center">
                                        ...
                                        <Badge variant="outline">
                                            Episode {anime === 'My Hero Academia' ? '88' : anime === 'Demon Slayer' ? '26' : '24'}
                                        </Badge>
                                    </div>
                                    <Progress value={anime === 'My Hero Academia' ? 80 : anime === 'Demon Slayer' ? 60 : 40} className="mt-2" />
                                </CardContent>
                            </Card>
                        ))}
                    </div>
