        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Anime Learning is a non-profit, educational entity. We do not
              intend to claim ownership of any anime content on this site
              nor do we monetize them. All anime content on this website
              belongs to the studios who created them.
            </p>
            <p className="text-sm text-muted-foreground">
              As per the Copyright Disclaimer under section 107 of the
              Copyright Act of 1976, allowance is made for &quot;fair
